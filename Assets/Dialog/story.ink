...
A new generation of Sirius Cybernetics Corporation robots and computers, with the new GPP feature. #F.DroneSpeed.3.2 #F.DroneName.BondJamesBond
* GPP feature? What is it?
    ...
    * Can it be avoided? -> instructions #E.HideOrangeDoor
    
    == instructions ==
    - You can turn of the GPP in the back room.#E.ShowBackRoom
    * Why can't you do that?
    - Brain the size of a planet and you want me to press panels. #E.HideBackRoom
    * I'll get it done #Q.InspectPanel
    ->END
